...
//Make Objects and meshes????
        textureLoader.load ('Code/Assets/RKHP copy.jpg', function (texture) { 
        ...
        objLoader.load('Kidney/blob/master/Code/Assets/RKLP.obj', function (object) {
        //objLoader by default loads .obj files in as bufferGeometry (not straight geometry)
         ...
         textureLoader.load ('Code/Assets/RKUHP.jpg', function (texture) {
         displacementMap.load('Code/Assets/RKUDisplace.jpg', function (displace){
         bumpMap.load('Code/Assets/RKUBump.jpg', function (norm){                 
        //load the given .obj file from the 'high' or 'low' folder based on user's graphics quality preference
        objLoader.load('Code/Assets/RKULP.OBJ', function (object) {
        //objLoader by default loads .obj files in as bufferGeometry (not straight geometry)
               object.traverse(function (child) { //traverse iterates contained function over all children of object
                var mat = new THREE.MeshPhysicalMaterial({
                map: texture,
         ...
         textureLoader.load ('Code/Assets/LKUHP.jpg', function (texture) {                 
         displacementMap.load('Code/Assets/LKU-Displace.jpg', function (displace){ 
         bumpMap.load('Code/Assets/LKUBump.jpg', function (norm){ 
        //load the given .obj file from the 'high' or 'low' folder based on user's graphics quality preference
        objLoader.load('Code/Assets/LKULP.OBJ', function (object) {
        //objLoader by default loads .obj files in as bufferGeometry (not straight geometry)
               object.traverse(function (child) { //traverse iterates contained function over all children of object
                var mat = new THREE.MeshPhysicalMaterial({
                map: texture,
        ...
        textureLoader.load ('Code/Assets/LKHP.jpg', function (texture) { 
        displacementMap.load('Code/Assets/LKDisplace.jpg', function (displace){  
        bumpMap.load('Code/Assets/LKBump.jpg', function (norm){               
        //load the given .obj file from the 'high' or 'low' folder based on user's graphics quality preference
        objLoader.load('Code/Assets/LKLP.OBJ', function (object) {
        //objLoader by default loads .obj files in as bufferGeometry (not straight geometry)
               object.traverse(function (child) { //traverse iterates contained function over all children of object
                var mat = new THREE.MeshPhysicalMaterial({
                map: texture,
        ...
        textureLoader.load ('Code/Assets/AortaHP.jpg', function (texture) { 
        displacementMap.load('Code/Assets/Aorta-Displace.jpg', function (displace){
        bumpMap.load('Code/Assets/AortaBump.jpg', function (norm){                
         //load the given .obj file from the 'high' or 'low' folder based on user's graphics quality preference
        objLoader.load('Code/Assets/AortaLP.OBJ', function (object) {
        //objLoader by default loads .obj files in as bufferGeometry (not straight geometry)
               object.traverse(function (child) { //traverse iterates contained function over all children of object
                 var mat = new THREE.MeshPhysicalMaterial({
                map: texture,
    ...
    textureLoader.load ('Code/Assets/IVC2018.jpg', function (texture) { 
    displacementMap.load('Code/Assets/IVC-Displace.jpg', function (displace){                  
    bumpMap.load('Code/Assets/IVCBump.jpg', function (norm){       
        //load the given .obj file from the 'high' or 'low' folder based on user's graphics quality preference
        objLoader.load('Code/Assets/IVCLP.OBJ', function (object) {
        //objLoader by default loads .obj files in as bufferGeometry (not straight geometry)
               object.traverse(function (child) { //traverse iterates contained function over all children of object
                 var mat = new THREE.MeshPhysicalMaterial({
                map: texture,
